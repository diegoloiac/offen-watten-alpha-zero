...
class WorldTotalWatten(object):
    ...
    def refresh(self):
        ...
        self.sub_watten_game = SubWattenGame()
    ...
    def act(self, action, agent):
        ...
        if action == moves["make_best_move"]:
            ...
            self.sub_watten_game.trueboard.init_world_to_state(self.current_player, self.distributing_cards_player,
                                                               self.player_A_hand, self.player_B_hand,
                                                               self.played_cards,
            ...
            if 0 <= move < 33:
                ...
                if move not in hand:
                    ...
                    raise InconsistentStateError(
                        f'Played card {move} not in {hand} of player {self.current_player}')
    ...
    def display(self):
        ...
        print(f"Moves series: {self.moves_series}")
        print(f"SubWatten moves series: {self.sub_watten_moves_series}")
