...
class MediumMediumNNet(NNet):
    ...
    def build_model(self):
        ...
        h_fc1 = Dropout(0.2)(Activation('relu')(BatchNormalization(axis=1)(Dense(512)(h_input))))
        h_fc2 = Dropout(0.2)(Activation('relu')(BatchNormalization(axis=1)(Dense(512)(h_fc1))))
        h_fc3 = Dropout(0.2)(Activation('relu')(BatchNormalization(axis=1)(Dense(512)(h_fc2))))
        h_fc4 = Dropout(0.2)(Activation('relu')(BatchNormalization(axis=1)(Dense(512)(h_fc3))))
    ...
    def clone(self):
        return MediumMediumNNet(self.observation_size_x, self.observation_size_y, 1, self.action_size, self.multi_gpu)
