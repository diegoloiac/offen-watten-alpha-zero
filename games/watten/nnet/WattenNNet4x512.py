...
class WattenNNet4x512(NNet):
    ...
    def build_model(self):
        ...
        h_fc8 = Dropout(0.2)(Activation('relu')(BatchNormalization(axis=1)(Dense(256)(h_fc7))))

        pi = Dense(self.action_size, activation='softmax', name='pi')(h_fc8)
        v = Dense(1, activation='tanh', name='v')(h_fc8)
    ...
    def clone(self):
        return WattenNNet4x512(self.observation_size_x, self.observation_size_y, 1, self.action_size, self.multi_gpu)
