...
class WattenNNetFirstLayerBig(NNet):
    ...
    def build_model(self):
        ...
        h_fc1 = Dropout(0.2)(Activation('relu')(BatchNormalization(axis=1)(Dense(2048)(h_input))))
    ...
    def clone(self):
        return WattenNNetFirstLayerBig(self.observation_size_x, self.observation_size_y, 1, self.action_size, self.multi_gpu)
