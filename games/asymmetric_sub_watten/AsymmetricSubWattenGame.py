...
sys.path.append('..')
sys.path.append('asymmetric_sub_watten')

import games.asymmetric_sub_watten.asymmetric_sub_watten as a_s_watten
import numpy as np
...
class AsymmetricSubWattenGame(Game):
    def __init__(self):
        self.trueboard = a_s_watten.WorldAsymmetricSubWatten()
