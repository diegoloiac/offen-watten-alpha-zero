...
class WorldAsymmetricSubWatten(object):

    def __init__(self):
        self.LOG = logging.getLogger('asymmetric_sub_watten_logger')
        self.refresh()
    ...
    def refresh(self):
        ...
        # the opponent picks rank and plays the first move
    ...
    def deepcopy(self):
        new_world = WorldAsymmetricSubWatten()
